...
with st.expander("❗❗ 글상자를 펼쳐 사용방법을 읽어보세요 👆✅", expanded=False):
    st.markdown(
        ...
        **2️⃣ [녹음 완료]** 버튼을 누르고 내가 한 말과 잉글링의 대답 들어보기.  
        3️⃣ 재생 막대의 버튼으로 재생 ▶ 해보기.  
         &emsp;천천히 들으려면 재생 막대의 오른쪽 점 세개(눈사람)버튼을 눌러 속도 조절하기.  
        4️⃣ 1~3번을 반복하기. 말문이 막힐 땐 **[잠깐 멈춤]** 버튼을 누른 후 **[녹음 시작]** 버튼을 다시 눌러 말하기.  
        5️⃣ 왼쪽 사이드 바의 **[대화 기록]** 을 확인하며 내가 잘 말하고 들었는지 확인이 가능합니다.
        """
    )
